...
namespace Calculadora
{
    class Program
    {
        static float RealizaOperação(float primeiroNumero, float segundoNumero, string operador)
        {
            switch (operador)
            {
        ...
        static void Main(string[] args)
        {
            ...
            float resultado = RealizaOperação(primeiroNumero, segundoNumero, operador);
